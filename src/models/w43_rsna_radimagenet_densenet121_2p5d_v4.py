%%writefile /kaggle/working/w43_rsna_radimagenet_densenet121_2p5d_v4.py
#!/usr/bin/env python3
# -*- coding: utf-8 -*-

"""
RSNA Knee Abnormality Detection
W43 — RadImageNet DenseNet-121 2.5D Multi-Plane v4
==========================================================================
...
running variances (also reported publicly for this checkpoint). W43 v4 does
NOT train against those source-domain running statistics unchanged.

Before Stage-P pseudo training, W43 v4:
...
W43 v4 performs a real pixel-decode preflight before cache construction:
...
CLI
---
    python w43_rsna_radimagenet_densenet121_2p5d_v4.py status --accelerator localGPU

    python w43_rsna_radimagenet_densenet121_2p5d_v4.py cache \
        --accelerator localGPU --cache-workers 8

    python w43_rsna_radimagenet_densenet121_2p5d_v4.py train_pseudo \
        --accelerator localGPU

    python w43_rsna_radimagenet_densenet121_2p5d_v4.py train_cv \
        --accelerator localGPU

    python w43_rsna_radimagenet_densenet121_2p5d_v4.py train_full \
        --accelerator localGPU

    python w43_rsna_radimagenet_densenet121_2p5d_v4.py train_all \
        --accelerator localGPU

    python w43_rsna_radimagenet_densenet121_2p5d_v4.py validate \
        --accelerator localGPU
...
SCRIPT_VERSION = "w43_radimagenet_densenet121_2p5d_v4"
DISPLAY_VERSION = "W43 | RadImageNet DenseNet-121 2.5D Multi-Plane v4"
OUTPUT_DIR_NAME = "rsna_w43_radimagenet_densenet121_2p5d_v4"
