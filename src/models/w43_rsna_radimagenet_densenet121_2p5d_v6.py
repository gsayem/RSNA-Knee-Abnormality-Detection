%%writefile /kaggle/working/w43_rsna_radimagenet_densenet121_2p5d_v6.py
#!/usr/bin/env python3
# -*- coding: utf-8 -*-

"""
RSNA Knee Abnormality Detection
W43 — RadImageNet DenseNet-121 2.5D Multi-Plane v6
==========================================================================
...
through emulation. W43 v6 does NOT use that result by itself.
...
--------------------------------------
W43 v6 forces the RadImageNet DenseNet-121 backbone to FP32.
...
running variances (also reported publicly for this checkpoint). W43 v6 does
NOT train against those source-domain running statistics unchanged.

Before Stage-P pseudo training, W43 v6:
...
W43 v6 performs a real pixel-decode preflight before cache construction:
...
CLI
---
    python w43_rsna_radimagenet_densenet121_2p5d_v6.py status --accelerator localGPU

    python w43_rsna_radimagenet_densenet121_2p5d_v6.py cache \
        --accelerator localGPU --cache-workers 8

    python w43_rsna_radimagenet_densenet121_2p5d_v6.py train_pseudo \
        --accelerator localGPU

    python w43_rsna_radimagenet_densenet121_2p5d_v6.py train_cv \
        --accelerator localGPU

    python w43_rsna_radimagenet_densenet121_2p5d_v6.py train_full \
        --accelerator localGPU

    python w43_rsna_radimagenet_densenet121_2p5d_v6.py train_all \
        --accelerator localGPU

    python w43_rsna_radimagenet_densenet121_2p5d_v6.py validate \
        --accelerator localGPU
...
SCRIPT_VERSION = "w43_radimagenet_densenet121_2p5d_v6"
DISPLAY_VERSION = "W43 | RadImageNet DenseNet-121 2.5D Multi-Plane v6"
OUTPUT_DIR_NAME = "rsna_w43_radimagenet_densenet121_2p5d_v6"
