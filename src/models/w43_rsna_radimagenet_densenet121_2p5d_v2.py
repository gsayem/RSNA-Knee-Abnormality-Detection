...
W43 — RadImageNet DenseNet-121 2.5D Multi-Plane v2
==========================================================================
...
running variances (also reported publicly for this checkpoint). W43 v2 does
NOT train against those source-domain running statistics unchanged.

Before Stage-P pseudo training, W43 v2:
...
CLI
---
    python w43_rsna_radimagenet_densenet121_2p5d_v2.py status --accelerator localGPU

    python w43_rsna_radimagenet_densenet121_2p5d_v2.py cache \
        --accelerator localGPU --cache-workers 8

    python w43_rsna_radimagenet_densenet121_2p5d_v2.py train_pseudo \
        --accelerator localGPU

    python w43_rsna_radimagenet_densenet121_2p5d_v2.py train_cv \
        --accelerator localGPU

    python w43_rsna_radimagenet_densenet121_2p5d_v2.py train_full \
        --accelerator localGPU

    python w43_rsna_radimagenet_densenet121_2p5d_v2.py train_all \
        --accelerator localGPU

    python w43_rsna_radimagenet_densenet121_2p5d_v2.py validate \
        --accelerator localGPU
...
SCRIPT_VERSION = "w43_radimagenet_densenet121_2p5d_v2"
DISPLAY_VERSION = "W43 | RadImageNet DenseNet-121 2.5D Multi-Plane v2"
OUTPUT_DIR_NAME = "rsna_w43_radimagenet_densenet121_2p5d_v2"
...
def run_status(paths: ProjectPaths, args, runtime: Runtime) -> Dict[str, Any]:
    ...
    payload = {
        ...
        "ready_for_cache": bool(
            data_error is None and dependency["pydicom"]
        ),
