...
W43 — RadImageNet DenseNet-121 2.5D Multi-Plane v1
==========================================================================
...
CLI
---
    python w43_rsna_radimagenet_densenet121_2p5d_v1.py status --accelerator localGPU

    python w43_rsna_radimagenet_densenet121_2p5d_v1.py cache \
        --accelerator localGPU --cache-workers 8

    python w43_rsna_radimagenet_densenet121_2p5d_v1.py train_pseudo \
        --accelerator localGPU

    python w43_rsna_radimagenet_densenet121_2p5d_v1.py train_cv \
        --accelerator localGPU

    python w43_rsna_radimagenet_densenet121_2p5d_v1.py train_full \
        --accelerator localGPU

    python w43_rsna_radimagenet_densenet121_2p5d_v1.py train_all \
        --accelerator localGPU

    python w43_rsna_radimagenet_densenet121_2p5d_v1.py validate \
        --accelerator localGPU
...
SCRIPT_VERSION = "w43_radimagenet_densenet121_2p5d_v1"
DISPLAY_VERSION = "W43 | RadImageNet DenseNet-121 2.5D Multi-Plane v1"
OUTPUT_DIR_NAME = "rsna_w43_radimagenet_densenet121_2p5d_v1"
