# ============================================================
# RSNA KNEE ABNORMALITY DETECTION - V3
#
...
#
# Phase: V3 spatially-aware slice representation
...
WORK_ROOT = Path("/kaggle/working/rsna_v3")
...
for fold in range(NUM_FOLDS):
    ...
    best_checkpoint = CHECKPOINT_ROOT / f"fold_{fold + 1}_best.pt"
...
print(
    fold_metrics_df[
        ["fold", "best_epoch", "final_macro_AUROC", "final_macro_AP", "final_macro_F1"]
...
# ============================================================
# 17. OUT-OF-FOLD PER-LABEL METRICS
# ============================================================
...
for fold in range(1, NUM_FOLDS + 1):
    ...
    print(CHECKPOINT_ROOT / f"fold_{fold}_best.pt")
