# ============================================================
# RSNA KNEE ABNORMALITY DETECTION - V1.1
#
...
#
# Phase: V1.1 frozen-backbone baseline with stabilized training protocol
...
WORK_ROOT = Path("/kaggle/working/rsna_v1_1")
...
print("\n")
print("=" * 90)
print("FINAL V1.1 FIXED-EPOCH OOF RESULTS")
print("=" * 90)
