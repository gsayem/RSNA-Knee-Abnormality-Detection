# ============================================================
# RSNA KNEE ABNORMALITY DETECTION - V1
#
...
WORK_ROOT = Path("/kaggle/working/rsna_v1")
...
class V1HierarchicalModel(nn.Module):
    def __init__(
        self,
        metadata_dim: int,
        num_labels: int,
