...
Current production implementation. Needed to optimize rather than rebuild from memory. and it's already optimized as `rsna_w2_6p_fast_logits_optimized.py`
## upload the rsna_w2_6p_fast.zip
